...
export default function ContactModal() {
  ...
  return (
    ...
    >
      ...
      {/* Social Links */}
      <div>
        <p className="text-xs uppercase tracking-wider text-on-surface-variant mb-4">Follow Us</p>
        <div className="flex items-center gap-3">
          <a
            href="#"
            className="w-10 h-10 flex items-center justify-center bg-surface-mid rounded-lg hover:bg-surface-highest transition-colors"
